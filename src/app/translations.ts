...
export const translations = {
  cs: {
    ...
    hero: {
      ...
      title2: "garantujeme výnos.",
      subtitle: "Základní kámen Vašeho portfolia",
      description: "Konzervativní nemovitostní fond s 9+ lety na trhu. Garantovaný výnos min. 7 % p.a., SRI 3/7, likvidita do 3 měsíců. Čtyři pilíře diverzifikace, 36 SPV entit pod správou.",
    ...
    about: {
      ...
      subtitle: "SPILBERK je český fond kvalifikovaných investorů zaměřený na dlouhodobé budování diverzifikovaného portfolia nemovitostních a energetických projektů. Investiční strategií je vytvoření odolného portfolia s využitím synergie čtyř pilířů.",
      ...
      row11key: "Garantované zhodnocení",
      ...
      guaranteeTitle1: "Garantované\nzhodnocení p.a.",
      guaranteeTitle2: "Výkonnost PIA\nza posledních 12M",
      guaranteeTitle3: "Maximální\nvýnos PIA p.a.",
      guaranteeDesc: "Garance min. výnosu PIA se uplatní i v případě nižšího zisku či ztráty fondu — redistribuce fondového kapitálu od VIA ve prospěch PIA. Údaje k 31. 12. 2024.",
    ...
    benefits: {
      ...
      benefit2title: "Garance minimálního výnosu",
      benefit2desc: "Min. 7 % p.a. pro držitele PIA, a to i v případě nižšího zisku či ztráty fondu.",
    ...
    steps: {
      ...
      step3desc: "Měsíční frekvence úpisu PIA. Garantovaný výnos min. 7 % p.a. (max. 7,2 %). Zajištění VIA:PIA = 5:1."
    },
    cta: {
      label: "Připraveni investovat?",
      title: "Stavíme nemovitosti, garantujeme výnos.",
      subtitle: "2,6+ mld CZK pod správou · 36 SPV · SRI 3/7 · Garance min. 7 % p.a. · Likvidita do 3 měsíců",
      invest: "Investujte s námi",
      badge1: "Nízké riziko",
    ...
    footer: {
      disclaimer: "SPILBERK investiční fond SICAV, a.s. je fondem kvalifikovaných investorů dle zákona č. 240/2013 Sb. (ZISIF). Hodnota investice může klesat i stoupat. KID na avantfunds.cz.",
      fundLabel: "Fond",
  ...
  en: {
    ...
    hero: {
      ...
      title2: "guaranteeing returns.",
      subtitle: "The cornerstone of your portfolio",
      description: "Conservative real estate fund with 9+ years on the market. Guaranteed return min. 7% p.a., SRI 3/7, liquidity within 3 months. Four pillars of diversification, 36 SPV entities under management.",
      cta: "Invest with us",
    ...
    about: {
      ...
      subtitle: "SPILBERK is a Czech qualified investor fund focused on long-term building of a diversified portfolio of real estate and energy projects. The investment strategy is to create a resilient portfolio using synergy of four pillars.",
      ...
      guaranteeTitle1: "Guaranteed\nreturn p.a.",
      guaranteeTitle2: "PIA performance\nover last 12M",
      guaranteeTitle3: "Maximum\nPIA return p.a.",
      guaranteeDesc: "Min. PIA return guarantee applies even in case of lower profit or fund loss — redistribution of fund capital from VIA in favor of PIA. Data as of Dec 31, 2024.",
    ...
    benefits: {
      ...
      benefit2title: "Guaranteed minimum return",
      benefit2desc: "Min. 7% p.a. for PIA holders, even in case of lower profit or fund loss.",
    ...
    steps: {
      ...
      step3desc: "Monthly PIA subscription frequency. Guaranteed return min. 7% p.a. (max. 7.2%). VIA:PIA security = 5:1."
    },
    cta: {
      label: "Ready to invest?",
      title: "Building properties, guaranteeing returns.",
      subtitle: "2.6+ bn CZK under management · 36 SPV · SRI 3/7 · Min. 7% p.a. guarantee · Liquidity within 3 months",
      invest: "Invest with us",
      badge1: "Low risk",
    ...
    footer: {
      disclaimer: "SPILBERK Investment Fund SICAV, a.s. is a qualified investor fund according to Act No. 240/2013 Coll. (ZISIF). Investment value may decrease or increase. KID at avantfunds.cz.",
      fundLabel: "Fund",
  ...
  it: {
    ...
    hero: {
      ...
      title2: "garantire rendimenti.",
      subtitle: "La pietra angolare del tuo portafoglio",
      description: "Fondo immobiliare conservativo con 9+ anni sul mercato. Rendimento garantito min. 7% p.a., SRI 3/7, liquidità entro 3 mesi. Quattro pilastri di diversificazione, 36 entità SPV sotto gestione.",
      cta: "Investi con noi",
    ...
    about: {
      ...
      subtitle: "SPILBERK è un fondo ceco per investitori qualificati focalizzato sulla costruzione a lungo termine di un portafoglio diversificato di progetti immobiliari ed energetici. La strategia di investimento è creare un portafoglio resiliente utilizzando la sinergia di quattro pilastri.",
      ...
      guaranteeTitle1: "Rendimento\ngarantito p.a.",
      guaranteeTitle2: "Performance PIA\nultimi 12M",
      guaranteeTitle3: "Rendimento\nmax. PIA p.a.",
      guaranteeDesc: "La garanzia di rendimento min. PIA si applica anche in caso di profitto inferiore o perdita del fondo — redistribuzione del capitale del fondo da VIA a favore di PIA. Dati al 31 dicembre 2024.",
    ...
    benefits: {
      ...
      benefit2title: "Rendimento minimo garantito",
      benefit2desc: "Min. 7% p.a. per i detentori di PIA, anche in caso di profitto inferiore o perdita del fondo.",
    ...
    steps: {
      ...
      step3desc: "Frequenza di sottoscrizione PIA mensile. Rendimento garantito min. 7% p.a. (max. 7,2%). Garanzia VIA:PIA = 5:1."
    },
    cta: {
      label: "Pronti a investire?",
      title: "Costruire proprietà, garantire rendimenti.",
      subtitle: "2,6+ mld CZK in gestione · 36 SPV · SRI 3/7 · Garanzia min. 7% p.a. · Liquidità entro 3 mesi",
      invest: "Investi con noi",
    ...
    footer: {
      disclaimer: "SPILBERK Fondo di Investimento SICAV, a.s. è un fondo per investitori qualificati secondo la Legge n. 240/2013 Racc. (ZISIF). Il valore dell'investimento può diminuire o aumentare. KID su avantfunds.cz.",
      fundLabel: "Fondo",
