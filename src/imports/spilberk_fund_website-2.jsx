...
export default function SpilberkFund() {
  ...
  const projects = [
    ...
    { name:"Kladno - Na Sestem", loc:"Kladno, ČR", units:488, cat:"development", status:"prep", img:IMG.kladno, desc:"31 bytových domů, 5 etap, domov seniorů 85 míst, kolaudace 06/2032" },
